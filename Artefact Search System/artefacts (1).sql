...
--
-- Table structure for table `categorypending`
--

CREATE TABLE `categorypending` (
  `id` int(4) NOT NULL,
...
--
-- Dumping data for table `categorypending`
--

INSERT INTO `categorypending` (`id`, `sellerid`, `catname`, `catimg`, `prodtype`, `prodimg`) VALUES
(1, 7, 'Toys', 'toys.jpg', 'Teddy Bear', 'teddy.jpg');
...
('althaf@gmail.com', 'qwertyuiop', 1, NULL),
...
('raju.ramana10@gmail.com', '1234567890', 0, NULL),
('rinsharinu@gmail.com', '123456789', 0, NULL),
('rinuu@gmail.com', 'fizzaamrin', 1, NULL),
('saj@gmail.com', '0987654321', 1, NULL),
...
(2, 'mac', 'lipstick', 'Mini Mac Lipstick - Twig Rs. 1,050', 'img2.jpg'),
(3, 'lakme', 'compact', 'Studio Fix Powder Plus Foundation - C2 Rs. 3,300', 'img3.jpg'),
(4, 'sugar', 'compact', 'Studio Fix Powder Plus Foundation - C2 Rs. 3,300', 'img4.jpg');

-- --------------------------------------------------------

--
-- Table structure for table `producttypepending`
--

CREATE TABLE `producttypepending` (
  `id` int(4) NOT NULL,
  `sellerid` int(4) NOT NULL,
  `catname` varchar(30) NOT NULL,
  `prodtype` varchar(30) NOT NULL,
...
('akhilamv13@gmail.com', '+919656488164'),
('rinsharinu@gmail.com', '+919846170951'),
('raju.ramana10@gmail.com', '+919867452321'),
('saj@gmail.com', '+919876641235'),
...
--
-- Table structure for table `sellercat`
--

CREATE TABLE `sellercat` (
  `catename` varchar(35) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
CREATE TABLE `sellerreg` (
  ...
  `idcard` varchar(15) NOT NULL DEFAULT '0',
  `drivlic` varchar(15) NOT NULL DEFAULT '0',
...
INSERT INTO `sellerreg` (`sellerid`, `fname`, `lname`, `email`, `phone`, `password`, `shopname`, `country_name`, `state_name`, `city_name`, `addr`, `gender`, `dob`, `age`, `gst`, `idproof`, `aadhar`, `idcard`, `drivlic`, `status`) VALUES
(24, 'Akhila', 'M', '1235@gmail.com', '+915679745865', 'Aa123528', '', '', '', '', 'dsgdsg', 'female', '2022-10-07', 0, '109873456789', 'aadhar', 2147483647, '0', '0', 1),
(30, 'Althaf', 'Muhammad', 'althaf@gmail.com', '+919762345678', 'qwertyuiop', '', 'India', 'Kerala', 'Tripunithura', 'Chemp PO , Vaikom', 'male', '2001-02-05', 21, 'we244567uh56', 'aadhar', 2147483647, '0', '0', 0),
(7, 'Raji', 'Vijayan', 'rajivijayan@gmail.com', '8137916930', '1234567890', '', '', 'Kerala', 'Tripunithura', 'Madhavam (h), thekkumbagom ', 'female', '1987-02-17', 35, '543567687908', 'aadhar', 1421567432, '0', '0', 1),
(26, 'rinu', 'r', 'rinuu@gmail.com', '+919947320968', 'fizzaamrin', '', '', '', '', 'serdthjio', 'female', '2022-10-06', 0, '123456789098', 'aadhar', 2147483647, '0', '0', 1),
(28, 'sajitha', 'yu', 'saj@gmail.com', '+919876641235', '0987654321', '', '', '', '', 'kjhgfdcvtyghyhuh', 'female', '2022-07-02', 0, '545678888678', 'aadhar', 2147483647, '0', '0', 1);
...
(1, 'Akhila', 'MV', '+919656488164', 'akhilamv13@gmail.com', 'akku1234', NULL),
(5, 'Jeslin', 'Johnson', '+918764214678', 'jeslin@gmail.com', 'asdfghjkl', NULL),
(7, 'Raju', 'ds', '+919867452321', 'raju.ramana10@gmail.com', '1234567890', NULL),
...
--
-- Indexes for table `categorypending`
--
ALTER TABLE `categorypending`
  ADD PRIMARY KEY (`id`);
...
--
-- Indexes for table `producttypepending`
--
ALTER TABLE `producttypepending`
  ADD PRIMARY KEY (`id`);
...
--
ALTER TABLE `category`
  MODIFY `catid` int(4) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;

--
-- AUTO_INCREMENT for table `categorypending`
--
ALTER TABLE `categorypending`
  MODIFY `id` int(4) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;

--
-- AUTO_INCREMENT for table `producttypepending`
--
ALTER TABLE `producttypepending`
...
--
ALTER TABLE `sellerreg`
  MODIFY `sellerid` int(4) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=31;
