                    ...
                    <div class="row">
                        ...
                        <div class="">
                            ...
                            <figure class="product-media">
                                                <a href="../mainhome/products.php?prodtype=<?php echo $prodtype ?>">
                                                    <img src="../seller/assets/images/producttype/<?php echo $prodimg ?>" alt="Product image" class="product-image">
                                                </a>

                                                <div class="product-action">
                                                    <a href="../mainhome/products.php?prodtype=<?php echo $prodtype ?>" class="btn-product btn-quickview"><span><?php echo $prodtype ?></span></a>
