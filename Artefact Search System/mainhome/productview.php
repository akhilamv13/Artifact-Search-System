                            ...
                            <div class="col-md-6">
                                <div class="product-gallery product-gallery-separated">
                                    ...
                                    <figure class="product-separated-item">
                                        <img src="../seller/assets/images/products/<?php echo $img1; ?>" data-zoom-image="../seller/assets/images/products/<?php echo $img1?>" alt="">
                                    ...
                                    <figure class="product-separated-item">
                                        <img src="../seller/assets/images/products/<?php echo $img2; ?>" data-zoom-image="../seller/assets/images/products/<?php echo $img2?>" alt="">
                                    </figure>

                                    <figure class="product-separated-item">
                                        <img src="../seller/assets/images/products/products/<?php echo $img3; ?>" data-zoom-image="../seller/assets/images/products<?php echo $img3?>" alt="">
                                    </figure>
