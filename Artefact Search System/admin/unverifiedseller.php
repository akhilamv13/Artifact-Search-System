                 ...
                 <div class="table-responsive">
                        <table class="table" border="1">
                          ...
                          <tbody>
                            ...
                            $sel='select * from sellerreg where status=0';
                            ...
                            <tr>
                              ...
                              <td><center style="font-size: 1.1em;color: #282828;"><a href='../admin/viewunverifiedseller.php?sellerid=<?php echo $sellerid ?>'><button class="btn btn-outline-primary-2">View More</button></a></center></td>
                            </tr>
                              <?php 
