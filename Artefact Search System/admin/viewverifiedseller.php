                  ...
                  <div class="row">
                    <div class="col-md-4 pr-1">
                      <div class="form-group">
                        ...
                        <input type="text"  name="country_name" class="form-control" placeholder="country" disabled="" maxlength="13"  required="" value="<?php echo $country_name ?>">
                      </div>
                    </div>
                    <div class="col-md-4 pl-1">
                      <div class="form-group">
                        <label style="color:#c96">State</label>
                        <input type="text"  name="state_name"  class="form-control" placeholder="state" disabled="" minlength="8" maxlength="15" required="" value="<?php echo $state_name ?>">
                      </div>
                    </div>
                    <div class="col-md-4 pl-1">
                      <div class="form-group">
                        <label style="color:#c96">City</label>
                        <input type="text"  name="city_name"  class="form-control" placeholder="city" disabled="" minlength="8" maxlength="15" required="" value="<?php echo $city_name ?>">
                      </div>
                    </div>
                  </div>
                  ...
                  <div class="row">
                    ...
                    <div class="col-md-4 px-1">
                      <div class="form-group">
                        ...
                        <input type="text"  name="idproof" class="form-control" placeholder="idproof" disabled="" required="" value="<?php echo $idproof ?>">
                      </div>
                    </div>
                    <div class="col-md-4 pl-1">
                      <div class="form-group">
                        <label style="color:#c96">ID Number</label>
                        <input type="text"  name="idnum" class="form-control" placeholder="idnum" disabled="" required="" onload="findid();">
                      </div>
                    </div>
                  </div>
