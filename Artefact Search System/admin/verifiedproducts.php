                        ...
                        <table class="table" border="1">
                          ...
                          <tbody>
                            ...
                            <tr>
                              ...
                              <form method="post" action="../admin/viewverifiedproduct.php?pid=<?php echo $pid ?>"><td><center style="font-size: 1.1em;color: #282828;"><button class="btn btn-outline-primary-2">View More</button></center></td></form>
                            </tr>
                              <?php 
