            			...
            			<div class="form-tab">
							...
							<div class="tab-content">
							    ...
							    <div class="tab-pane fade show active" id="register-2" role="tabpanel" aria-labelledby="register-tab-2">
							    	<form method="post" action="../admin/catback.php">
							    		<div class="form-group">
							    			<label for="register-email-2">Category Name</label>
							    			<input type="text" class="form-control"  name="catname" required=""  autocomplete="off">
							    		</div><!-- End .form-group -->

							    		<div class="form-group">
							    			<label for="register-password-2">Categoty image</label>
