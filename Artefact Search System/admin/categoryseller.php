            ...
            <nav aria-label="breadcrumb" class="breadcrumb-nav border-0 mb-0">
                <div class="container">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">Category By Seller</li>
                    </ol>
                </div><!-- End .container -->
                 ...
                 <div class="table-responsive">
                        <table class="table" border="1">
                          ...
                          <tbody>
                            ...
                            $sel='select * from categorypending';
                            ...
                            <tr>
                              ...
                              <td><center style="font-size: 1.1em;color: #282828;"><a href="../admin/verifycat.php?id=<?php echo $id ?>"><button class="btn btn-outline-primary-2" onclick="return checkVerify()">Verify</button></a></center></td>
                            
                              <td><center style="font-size: 1.1em;color: #282828;"><a href='../admin/deletecat.php?id=<?php echo $id ?>'><button class="btn btn-outline-primary-2" onclick="return checkDelete()">Delete</button></a></center></td>
                            </tr>
