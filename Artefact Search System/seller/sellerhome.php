    ...
    <div class="page-wrapper">
            ...
            <div class="header-middle sticky-header">
                <div class="container">
                    <div class="header-left">
                        ...
                        <nav class="main-nav">
                            <center><ul class="menu sf-arrows">
        ...
        <main class="main">
            <nav aria-label="breadcrumb" class="breadcrumb-nav border-0 mb-0">
                <div class="container">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">Sellerhome</li>
                    </ol>
                </div><!-- End .container -->
        	...
        	<div class="page-header text-center" style="background-image: url('assets/images/page-header-bg.jpg')">
                ...
                <div class="btn-wrap">
                    <br>
                    <a href="../seller/login.php" class="btn btn-primary btn-round">Log in</a>
                </div>
                <div class="btn-wrap">
                    <br>
                    <a href="../seller/registration.php" class="btn btn-primary btn-round">Register</a>
                </div>
        	</div><!-- End .page-header -->
                    ...
                    <div class="row">
                        <div class="col-lg-10 offset-lg-1">
                            <div class="about-text text-center mt-3">
                                ...
                                <p>Classimax Marketplace for Promoting your products online. Be it a manufacturer, vendor or supplier, simply introduce your products online on Classimax and become a top e-commerce player with minimum investment. 

Promoting or Introducing your products on Classimax is easy and absolutely free. All you need is to register, add your product and start promoting your products.
                    ...
                    <div class="row justify-content-center">
                        <div class="col-lg-4 col-sm-6">
                            <div class="icon-box icon-box-sm text-center">
                                ...
                                <div class="icon-box-content">
                                    <h3 class="icon-box-title">Growth in Online Retail Market</h3><!-- End .icon-box-title -->
                                    <p>Witnessing tremendous growth for the past 5 years, retailers are moving towards online selling.Take a step forward to promote your products online.</p>
                        ...
                        <div class="col-lg-4 col-sm-6">
                            <div class="icon-box icon-box-sm text-center">
                                ...
                                <div class="icon-box-content">
                                    <h3 class="icon-box-title">Get orders accross india</h3><!-- End .icon-box-title -->
                        ...
                        <div class="col-lg-4 col-sm-6">
                            <div class="icon-box icon-box-sm text-center">
                                ...
                                <div class="icon-box-content">
                                    <h3 class="icon-box-title">No brand regulations</h3><!-- End .icon-box-title -->
                        ...
                        <div class="row">
                            ...
                            <div class="col-6 col-md-3">
                                <div class="count-container text-center">
                                    ...
                                    <h3 class="count-title text-white">Work experience</h3><!-- End .count-title -->
                                </div><!-- End .count-container -->
                            </div><!-- End .col-6 col-md-3 -->
                        </div><!-- End .row -->
                    </div><!-- End .container -->
