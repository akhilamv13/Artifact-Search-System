                ...
                <div class="gallery-grids">
                    <div class="row">
                                    <?php
                                        ...
                                        $query2="select * from productdet where sellerid='$sellerid' and prodtype='$prodtype'";
                        ...
                        <div class="">
                            ...
                            <figure class="product-media">
                                                <a href="../seller/productview.php?pid=<?php echo $pid?>">
                                                    <img src="assets/images/products/<?php echo $img1; ?>" alt="Product image" class="product-image">
                                                </a>

                                                <div class="product-action">
                                                    <a href="../seller/productview.php?pid=<?php echo $pid?>" class="btn-product btn-quickview"><span><?php echo $prodtype ?></span></a>
                            ...
                            <div class="product-body">
                                                ...
                                                <h3 class="product-title"><a href="../seller/productview.php?pid=<?php echo $pid?>"><?php echo $prodtitle ?></a></h3><!-- End .product-title -->
                                                <div class="product-price">
                                                    RS.<?php echo $price ?>/-
                                                </div><!-- End .product-price -->
                                                <div class="product-price">
                                                    <a href="#"><?php if($status==1) {echo("Verified");}else{echo("Not Verified");} ?></a>
                                                </div>
                                                <div class="product-nav product-nav-thumbs">
                                                    <a href="#" class="active">
                                                        <img src="assets/images/products/<?php echo $img1 ?>" alt="">
                                                    </a>
                                                    <a href="#">
                                                        <img src="assets/images/products/<?php echo $img2 ?>" alt="">
                                                    </a>

                                                    <a href="#">
                                                        <img src="assets/images/products/<?php echo $img3 ?>" alt="">
                                                    </a>
                                                </div><!-- End .product-nav -->
