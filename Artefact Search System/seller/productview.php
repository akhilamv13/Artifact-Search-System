                            ...
                            <div class="col-md-6">
                                <div class="product-gallery product-gallery-separated">
                                    ...
                                    <figure class="product-separated-item">
                                        <img src="assets/images/products/<?php echo $img1; ?>" data-zoom-image="assets/images/products/single/sticky/1-big.jpg" alt="product image">
                                    ...
                                    <figure class="product-separated-item">
                                        <img src="assets/images/products/<?php echo $img2; ?>" data-zoom-image="assets/images/products/single/sticky/2-big.jpg" alt="product image">
                                    </figure>

                                    <figure class="product-separated-item">
                                        <img src="assets/images/products/<?php echo $img3; ?>" data-zoom-image="assets/images/products/single/sticky/3-big.jpg" alt="product image">
                                    </figure>
                            ...
                            <div class="col-md-6">
                                <div class="product-details sticky-content">
                                    ...
                                    <div class="product-details-action">
                                        <a href="../seller/editproduct.php?pid=<?php echo $pid ?>" class="btn btn-primary"><span>Edit Product</span></a>

                                        <div class="details-action-wrapper">
                                            <a href="../seller/delete.php?pid=<?php echo $pid ?>" class="btn btn-primary" onclick="return checkDelete()"><span>Delete Product</span></a>
