...
<?php
  ...
  $update1="update usererreg set phone='$phone1',country_name='$country1',state_name='$state1',city_name='$city1',addr='$addr1' where email='$email'";
            ...
            <div class="login-page bg-image pt-8 pb-8 pt-md-12 pb-md-12 pt-lg-17 pb-lg-17" style="background-image: url('assets/images/backgrounds/login-bg.jpg')">
            	<div class="container">
            		<div class="form-box" style="max-width: 100%;">
                        ...
                        <div class="card-body">
                <form name="details" action="profile.php" method="POST">
                  <div class="row">
                  ...
                  <div class="row">
                    ...
                    <div class="col-md-6 pl-1">
                      <div class="form-group">
                        ...
                        <input type="text"  name="phone" class="form-control" placeholder="phone" onkeypress="return isNumber(event)"  value="<?php echo $phone ?>">
                      </div>
                    </div>
                  </div>
                  <br>
                  ...
                  <div class="row">
                        ...
                        <select type="text" name="country" id="country" class="form-control">
                          <option >Select Country</option>
                              ...
                              <?php 
                                ...
                                echo $country; ?>
                                <option value="<?php echo $row['country_id']; ?>" <?php if($row['country_id']==$country_name) echo 'selected="selected"' ?>><?php echo $row['country_name'] ?></option>
                                <?php
                    ...
                    <div class="col-md-4 pl-1">
                      <div class="form-group">
                        ...
                        <!-- <input type="text"  name="state"  class="form-control" placeholder="state"  minlength="8" maxlength="15" required="" value="<?php echo $arr3['state_name'];?>"> -->
                        <select type="text" id="state" name="state" class="form-control">
                          <option >Select State</option>
                         <?php 
                                $query1= "select * from state where state_id='$state_name'";
                                echo $query1;
                                $result1= mysqli_query($conn,$query1);
                                $row1= mysqli_fetch_assoc($result1)?>
                                <option value="<?php echo $row1['state_id']; ?>" <?php if($row1['state_id']==$state_name) echo 'selected="selected"' ?>><?php echo $row1['state_name'] ?></option>
                                <?php
                                $category=$row1['state_name'];
                                echo $category;
                                ?>
                    ...
                    <div class="col-md-4 pl-1">
                      <div class="form-group">
                        ...
                        <!-- <input type="text"  name="city"  class="form-control" placeholder="city" minlength="8" maxlength="15" required="" value="<?php echo $arr4['city_name'];?>"> -->
                        <select name="city" id="city" class="form-control">
                          <option >Select City</option>
                         <?php 
                                $query1= "select * from city where city_id='$city_name'";
                                echo $query1;
                                $result1= mysqli_query($conn,$query1);
                                $row1= mysqli_fetch_assoc($result1)?>
                                <option value="<?php echo $row1['city_id']; ?>" <?php if($row1['city_id']==$city_name) echo 'selected="selected"' ?>><?php echo $row1['city_name'] ?></option>
                                <?php
                                $category=$row1['city_name'];
                                echo $category;
                                ?>
                  ...
                  <div class="row">
                    <div class="col-md-12 pr-1">
                      <div class="form-group">
                        ...
                        <input type="text"  name="addr" class="form-control" placeholder="Address" required=""  value="<?php echo $addr ?>">
                      </div>
                    </div>
                  </div>
                  <div class="row">
                  ...
                  <div class="row">
                    ...
                    <div class="col-md-4 pl-1">
                      <div class="form-group">
                        ...
                        <input type="text"  name="idnum" id="idnum" class="form-control" placeholder="idnum" disabled="" required="" onload="findid()">
                      </div>
                    </div>
                  </div>
