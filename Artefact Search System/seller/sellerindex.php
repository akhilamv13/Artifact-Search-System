    ...
    <div class="page-wrapper">
                        ...
                        <nav class="main-nav">
                            <ul class="menu sf-arrows">
                                <li class="megamenu-container active">
                                    <a href="../seller/sellerindex.php">Home</a>
                                </li>
                                <li>
                                    <a href="../seller/profile.php">Profile</a>
                                </li>
                                <li>
                                    <a href="../seller/addproduct.php">Add Product</a>
                                </li>
                                <li>
                                    <a href="../seller/producttypes.php">Products</a>
                                </li>
                                <li>
                                    <a href="../mainhome/index.php" style="margin-left: 400%;">Logout</a>
                                </li>
                            </ul><!-- End .menu -->
                        </nav><!-- End .main-nav -->
                    </div><!-- End .header-left -->
        ...
        <main class="main">
            ...
            <div class="page-header text-center" style="background-image: url('assets/images/page-header-bg.jpg')">
                <div class="container">
                    <h1 class="page-title">Welcome <br><h1 style="color: #c96;text-transform: uppercase;"><?php echo $fname ?></h1></h1>
                </div><!-- End .container -->
            </div><!-- End .page-header -->
<br>
