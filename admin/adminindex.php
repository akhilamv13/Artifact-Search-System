          ...
          <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav ml-auto main-nav ">
              <li class="nav-item active">
                <a class="nav-link" href="../mainhome/index.html">Home</a>
              </li>
              <!--
              <li class="nav-item">
              ...
              <li class="nav-item dropdown dropdown-slide">
                <a class="nav-link dropdown-toggle" href="" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                  Users <span><!--<i class="fa fa-angle-down"></i>--></span>
                </a>
                <!-- Dropdown list -->
               ...
               <div class="dropdown-menu dropdown-menu-right">
                  ...
                  <a class="dropdown-item" href="../admin/seller.php">Sellers</a>
                </div>
              </li>
            </ul>
            <ul class="navbar-nav ml-auto mt-10">
              <li class="nav-item">
                <a class="nav-link login-button" href="../mainhome/index.php">Logout</a>
              </li>
            </ul>
          </div>
        </nav>
