		...
		<div class="row">
			...
			<div class="col-md-10 offset-md-1 col-lg-8 offset-lg-0"> -->
				...
				<div class="widget dashboard-container my-adslist">
					...
					<th><b><center style="font-size: 1.2em;">EMAIL ID</center></b></th>
					<th><b><center style="font-size: 1.2em;">MOBILE</center></b></th>
						...
						<?php
  						...
  						?>
  				<tr>
  					<td class="product-category"><center style="font-size: 1.1em;"><?php echo $userid; ?></center></td>
  					<td class="product-category"><center style="font-size: 1.1em;"><?php echo $fname." ".$lname; ?></center></td>
  					<td class="product-category"><center style="font-size: 1.1em;"><?php echo $phone; ?></center></td>
  					<td class="product-category"><center style="font-size: 1.1em;"><?php echo $email; ?></center></td>
  				</tr>
  						<?php
