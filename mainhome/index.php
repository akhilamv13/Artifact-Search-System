...
<head>
  ...
  <!-- favicon-->
  <link rel="icon" href="https://i.pinimg.com/474x/ba/fc/0a/bafc0ab62c8671e49e5ea663e100289f.jpg">
	...
	<div style="align-items: center;">
		<div class="col-lg-12 col-md-12">
			<div class="block d-flex" style="margin-left:25%;">
 			...
 			<input type="text" class="form-control mb-2 mr-sm-2 mb-sm-0"name="search" required value="<?php if(isset($_GET['search'])){echo $_GET['search']; } ?>" class="form-control" placeholder="Search data">
             <button type="submit" class="btn btn-main" class="btn btn-primary">Search</button>
         </form>
			</div>
		</div><br>
                                    ...
                                    if(isset($_GET['search']))
                                    {
                                        ...
                                        if(mysqli_num_rows($query_run) > 0)
                                        {
                                            foreach($query_run as $items)
                                            {
                                                ?>
                                                <tr>
                                                	<td><center style='font-size: 1.1em;'><img style='width:150px;height: 100px;' src='../mainhome/images/<?= $items['pid']; ?>' alt=''/></center></td>
                                                    <td><?= $items['pid']; ?></td>
                                                    <td><?= $items['pname']; ?></td>
                                                    <td><?= $items['ptype']; ?></td>
				...
				<!-- <div class="advance-search"> -->
					<!-- <form action="#"> -->
						<!-- <div class="row"> -->
							...
							<!-- <div class="col-lg-12 col-md-12">
								<div class="block d-flex">
									<input type="text" class="form-control mb-2 mr-sm-2 mb-sm-0" style="width: 500px ; height: 40px;" id="search" placeholder="Search for store"> -->

									<!-- Search Button -->
									<!-- <button class="btn btn-main" style="height: 40px ;">SEARCH</button>
								</div>
							</div> -->
						<!-- </div>
					</form> -->
		...
		<div class="row">
			<div class="col-md-12">
				<div class="section-title">
					...
					<p>Get high quality products quickly.</p>
				</div>
			</div>
		</div>
